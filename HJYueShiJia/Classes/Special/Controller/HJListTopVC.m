...
@interface HJListTopVC ()<UITableViewDelegate,UITableViewDataSource>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HJListTopCell *cell=[tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell=[HJListTopCell hj_viewFromXib];
    }
...
-(void)getData
{
    ...
    NSArray *listArr=json[@"datas"][@"article_list"];
    for (NSDictionary *dict in listArr) {
        HJListTopModel *model=[HJListTopModel mj_objectWithKeyValues:dict];
